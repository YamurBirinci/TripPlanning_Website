        ...
        <div className="Background_SignUp_Rectangle">
            ...
            <div className="container">
                <div className="text_group field" style={{ width: '200px', left: '-40px', top: '-70px' }}>
                    <input type="input" className="text_box" style={{ width: '200px'}} placeholder="month" name="month" id='month' required />
                ...
                <div className="text_group field" style={{ width: '200px', left: '0px', top: '-70px' }}>
                    <input type="input" className="text_box" style={{ width: '200px'}} placeholder="year" name="year" id='year' required />
            ...
            <div className="text_group field" style={{ width: '459px', top: '-170px', left: '375px'}}>
                <input type="input" className="text_box" style={{ width: '459px'}} placeholder="Number" name="Number" id='Number' required />
            ...
            <div className="text_group field" style={{ width: '459px', top: '-270px', left: '375px'}}>
                <input type="input" className="text_box" style={{ width: '459px'}} placeholder="CVC" name="CVC" id='CVC' required />
