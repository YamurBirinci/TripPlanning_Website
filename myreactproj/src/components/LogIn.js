...
function SignUp() {
    ...
    return (
        <div class="Background_SignUp_Rectangle">
            <button class="name_logo" style={{ height: '100px', border: '0px', backgroundColor: 'transparent'}} onClick={handleHomepageClick} ></button>
            ...
            <button className="to_signup" onClick={handleSignUpClick}>I want to create an account</button>
