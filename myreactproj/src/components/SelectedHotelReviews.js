                    ...
                    {visibleCommentPanel && (<div className='Comment-Panel'>
                        ...
                        <div className='container' style={{ height: '150px'}}>
                            <div class="form__group field" style={{ width: '200px', left: '0px', top: '-70px' }}>
                                <input type="input" class="form__field" style={{ width: '120px'}} placeholder="Location" name="Location" id='LocationRate' required />
                                <label for="LocationRate" class="form__label">Location</label>
                            </div>
                            <div class="form__group field" style={{ width: '200px', left: '0px', top: '-70px' }}>
                                <input type="input" class="form__field" style={{ width: '120px'}} placeholder="StaffRate" name="StaffRate" id='StaffRate' required />
                                <label for="StaffRate" class="form__label">Staff</label>
                            </div>
                            <div class="form__group field" style={{ width: '200px', left: '0px', top: '-70px' }}>
                                <input type="input" class="form__field" style={{ width: '120px'}} placeholder="CleanlinessRate" name="CleanlinessRate" id='CleanlinessRate' required />
                                <label for="CleanlinessRate" class="form__label">Cleanliness</label>
                            </div>
                        </div>
                        <div>
