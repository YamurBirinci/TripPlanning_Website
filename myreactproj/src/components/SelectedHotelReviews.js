                    ...
                    {visibleCommentPanel && (<div className='Comment-Panel'>
                        ...
                        <div className='container' style={{ height: '150px'}}>
                            <div className="form__group field" style={{ width: '200px', left: '0px', top: '-70px' }}>
                                <input type="input" className="form__field" style={{ width: '120px'}} placeholder="Location" name="Location" id='LocationRate' required />
                                <label for="LocationRate" className="form__label">Location</label>
                            </div>
                            <div className="form__group field" style={{ width: '200px', left: '0px', top: '-70px' }}>
                                <input type="input" className="form__field" style={{ width: '120px'}} placeholder="StaffRate" name="StaffRate" id='StaffRate' required />
                                <label for="StaffRate" className="form__label">Staff</label>
                            </div>
                            <div className="form__group field" style={{ width: '200px', left: '0px', top: '-70px' }}>
                                <input type="input" className="form__field" style={{ width: '120px'}} placeholder="CleanlinessRate" name="CleanlinessRate" id='CleanlinessRate' required />
                                <label for="CleanlinessRate" className="form__label">Cleanliness</label>
                            </div>
                        </div>
                        <div>
