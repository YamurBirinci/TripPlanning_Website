        ...
        <div className="Background_SignUp_Rectangle">
            ...
            <div className="container">
                <div className="form__group field" style={{ width: '200px', left: '-40px', top: '-70px' }}>
                    ...
                    <label htmlFor="name" className="form__label"><FontAwesomeIcon icon={faUser}></FontAwesomeIcon> First Name</label>
                </div>
                <div className="form__group field" style={{ width: '200px', left: '0px', top: '-70px' }}>
                    ...
                    <label htmlFor="name" className="form__label"><FontAwesomeIcon icon={faUser}></FontAwesomeIcon> Last Name</label>
                </div>
            </div>
            <div className="form__group field" style={{ width: '459px', top: '-170px', left: '375px'}}>
                ...
                <label htmlFor="mail" className="form__label"><FontAwesomeIcon icon={faEnvelope}></FontAwesomeIcon> E-mail</label>
            </div>
            <div className="form__group field" style={{ width: '459px', top: '-270px', left: '375px'}}>
                ...
                <label htmlFor="Password" className="form__label"><FontAwesomeIcon icon={faLock}></FontAwesomeIcon> Password</label>
            </div>
            <div className="form__group field" style={{ width: '459px', top: '-370px', left: '375px'}}>
                ...
                <label htmlFor="Confirmation" className="form__label"><FontAwesomeIcon icon={faLock}></FontAwesomeIcon> Password Confirmation</label>
            </div>
