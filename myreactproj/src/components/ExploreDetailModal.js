      ...
      <div className="modal-content">
        ...
        {visibleCommentPanel && (<div className='Comment-Panel' style={{ top: '30px', position: 'relative', width: '770px', left: "40px", height: '300px', marginBottom: '20px'}}>
          ...
          <div className='container' style={{ height: '150px', marginBottom: '-150px'}}>
            <div class="form__group field" style={{ width: '200px', left: '15px', top: '-90px'}}>
              <input type="input" class="form__field" style={{ width: '120px'}} placeholder="Vote" name="Vote" id='Vote' required />
              <label for="Vote" class="form__label">Your Vote</label>
            </div>
          </div>
