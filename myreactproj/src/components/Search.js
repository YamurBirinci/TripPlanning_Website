  ...
  return (
    <div className="Background_Rectangle" style={{ height: '900px'}}>
        ...
        <div style={{display: 'flex'}}>
            <div className='filter' style={{top: '0px', width: '200px'}}>
            <div>
            <h3 style={{color: '#343434'}}>Rate</h3>
            ...
            <div>
                <h3 style={{color: '#343434'}}>Amenities</h3>
        ...
        {Hotels.filter(Hotel => Hotel.Hotel_Location.includes(Search_Location)).map(Hotel => 
                    (<div key={Hotel}> <div className="Search-Container" style={{transform: 'scale(0.85)', left: '-25px'}}>
                        ...
                        <button className="search_button" style={{left: '770px', top: '-45px', fontSize: '22px', width: '200px', height: '50px', borderRadius: '15px', transform: 'scale(0.88)'}} onClick={ClickingExplore}>Explore!</button> 
                    </div>))} 
